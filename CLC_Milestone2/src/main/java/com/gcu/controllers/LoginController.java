...
public class LoginController {
	...
	public String processLogin(LoginModel loginModel, BindingResult bindingResult, Model model) 
	{
	...
	public String processReg(RegModel regModel, BindingResult bindingResult, Model model1) 
	{
		return "UserReg";
